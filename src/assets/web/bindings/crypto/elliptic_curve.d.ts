export { Pallas, Vesta, GroupAffine, GroupProjective, GroupMapPallas, ProjectiveCurve, };
...
declare function createCurveProjective(p: bigint, generator: GroupProjective, endoBase: bigint, endoScalar: bigint, b: bigint, a: bigint): {
    zero: {
        x: bigint;
        y: bigint;
        z: bigint;
