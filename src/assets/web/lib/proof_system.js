...
function ZkProgram(config) {
    ...
    async function compile() {
        let { provers, verify, verificationKey } = await compileProgram(publicInputType, publicOutputType, methodIntfs, methodFunctions, selfTag, config.overrideWrapDomain);
...
async function compileProgram(publicInputType, publicOutputType, methodIntfs, methods, proofSystemTag, overrideWrapDomain) {
